...
Core Analysis Salary Inference - Automatically detects monthly income patterns with confidence indicators
...
Explainable AI Confidence Indicators - All insights include confidence levels (Low/Medium/High)
...
Upload transaction data in CSV format with columns:
date (YYYY-MM-DD)
merchant (e.g., "TESCO")
